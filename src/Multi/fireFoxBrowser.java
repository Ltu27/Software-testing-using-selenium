...
public class fireFoxBrowser {
	...
	public void FirefoxBrowser() {
		...
		Action moveToLocation = actions.moveByOffset(100, 100).click().build();
		moveToLocation.perform();
		...
		WebElement foo3 = new WebDriverWait(driver, Duration.ofSeconds(3))
				.until(driver -> driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[1]/div/div/h2")));
		WebElement tACNTT3 = driver.findElement(By.xpath("//html/body/div[1]/div[2]/div[2]/div/div/div/div/div/div/div/div/a/b[1]"));
		tACNTT3.click();
